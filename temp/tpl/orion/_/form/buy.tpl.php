<form action="formsave" class="<?=$param["block_form_prefix"];?>block  <?=$param["block_form_mod"];?>"  >
	...
	<div class="<?=$param["block_form_prefix"];?>inner  <?=$param["block_form_mod"];?>"  >
		<div class="row <?=$param["block_form_prefix"];?>row  is--wrap">
			<input type="hidden" name="<?=$param["block_form_id"];?>[Продукция]" value="<?=t($this->post['id']);?>" />
			...
			<div class="cols <?=$param["block_form_prefix"];?>cols  <?=$param["block_form_mod"];?>  is--email">
				<div class="<?=$param["block_form_prefix"];?>item">
					<input type="email" class="<?=$param["block_form_prefix"];?>control form-control validate[required,custom[email]]  <?=$param["block_form_color"];?>  <?=$param["block_form_color"];?>" id="<?=$param["block_form_id"];?>[email]" name="<?=$param["block_form_id"];?>[Телефон]" placeholder="Ваш E-mail:">
				</div>	
			</div>
