		...
		<div class="row <?=$param["block_prefix"];?>row  is--wrap">
			...
			<div class="cols <?=$param["block_prefix"];?>cols  <?=$param["block_mod"];?>  is--email">
				<div class="<?=$param["block_prefix"];?>item">
					<input type="email" class="<?=$param["block_prefix"];?>control form-control validate[required,custom[email]]  <?=$param["block_mod"];?>" id="<?=$param["block_id"];?>[email]" name="user_login" placeholder="E-mail:">
				</div>	
			</div>
			*/
			?>
			<div class="cols <?=$param["block_prefix"];?>cols  <?=$param["block_mod"];?>  is--email">
				<div class="<?=$param["block_prefix"];?>item">
					<input type="text" class="<?=$param["block_prefix"];?>control form-control validate[required]  <?=$param["block_mod"];?>" id="<?=$param["block_id"];?>[email]" name="user_login" placeholder="Логин или E-mail">
				</div>	
			</div>
