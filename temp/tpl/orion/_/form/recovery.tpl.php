<form action="#" class="<?=$param["block_prefix"];?>block  <?=$param["block_mod"];?>  is--enter azbn__simple-response__form" data-method="profile/reset_password" > 
		...
		<div class="row <?=$param["block_prefix"];?>row  is--wrap">
			<div class="cols <?=$param["block_prefix"];?>cols  <?=$param["block_mod"];?>  is--email">
				<div class="<?=$param["block_prefix"];?>item">
					<input type="email" class="<?=$param["block_prefix"];?>control form-control validate[required,custom[email]]  <?=$param["block_mod"];?>  {{form_color}}" id="<?=$param["block_id"];?>[email]" name="email" placeholder="E-mail">
				</div>	
			</div>
