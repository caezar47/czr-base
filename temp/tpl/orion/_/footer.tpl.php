		...
		<?
			...
			//$modal_btn = get_field('modal_btn', $modal_id);
			$this->tpl(
				'_/modals/simple-response', 
				array(
					"block_prefix" => "modal-base__",
					"block_tpl" => "basket",
					"block_mod" => "is--basket",
					"block_modal_id" => "modal-simple-response",
					"block_heading" => '',//$modal_heading,
					"block_note" => '',//$modal_heading_small,
					"block_form_id" => "fbm",
		...
		<script src="<?=$this->path('js');?>/azbn7__ui__common.js" ></script>
		<?
			if($this->post['id'] == 1) {
			...
			if($this->post['id'] == 6 || $this->post['id'] == 311 || $this->post['id'] == 316) {
				$this->tpl('_/script/fancybox');
			}
