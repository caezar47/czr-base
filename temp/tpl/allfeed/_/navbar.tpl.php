					...
					<div class="<?=$__prefix;?>header">
						<div class="row <?=$__prefix;?>row-header ">
							...
							<div class="cols <?=$__prefix;?>cols-header  is--brand">
								<a class="<?=$__prefix;?>brand" href="<?=l(1);?>">
					...
					<div class="<?=$__prefix;?>collapse" >
						<div class="<?=$__prefix;?>collapse-inner">
							<div class="row <?=$__prefix;?>collapse-row">
								<div class="cols <?=$__prefix;?>collapse-cols cols  is--left">
									<a class="<?=$__prefix;?>brand" href="<?=l(1);?>">
										<svg class="icon-svg icon-logotip" role="img"><use xlink:href="<?=$this->path('img');?>/svg/sprite.svg#logotip"></use></svg>
									</a>
								</div>
								<div class="cols <?=$__prefix;?>collapse-cols cols  is--center">		
								...
								<div class="cols <?=$__prefix;?>collapse-cols cols  is--right">
								<?if ($phone != ""){?>
									<div class="<?=$__prefix;?>tel-block">
										<a href="tel:+<?=$phone_num?>" class="<?=$__prefix;?>tel">
											<span class="<?=$__prefix;?>tel-icon">
												<svg class="icon-svg icon-contacts-tel" role="img"><use xlink:href="<?=$this->path('img');?>/svg/sprite.svg#contacts-tel"></use></svg>
											</span> 
											<span class="<?=$__prefix;?>tel-name"><?=$phone;?></span>
										</a>
									</div>
								<?}?>								
								</div>
