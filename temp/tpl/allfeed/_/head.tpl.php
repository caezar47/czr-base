...
<link rel="mask-icon" href="<?=$this->path('favicon');?>/safari-pinned-tab.svg" color="#003e27">
<link rel="shortcut icon" href="<?=$this->path('favicon');?>/favicon.ico">
<meta name="apple-mobile-web-app-title" content="allfeed.pro">
<meta name="application-name" content="allfeed.pro">
