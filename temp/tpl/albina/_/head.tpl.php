...
<link rel="mask-icon" href="<?=$this->path('favicon');?>/safari-pinned-tab.svg" color="#ff887a">
<link rel="shortcut icon" href="<?=$this->path('favicon');?>/favicon.ico">
<meta name="apple-mobile-web-app-title" content="doctor-albina.ru">
<meta name="application-name" content="doctor-albina.ru">
