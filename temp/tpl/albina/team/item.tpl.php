...
$team_blog = get_field('team_blog', $id);
$team_blog_link = get_term_link($team_blog);
//var_dump($team_blog);
//var_dump($team_blog_link);
?>
...
$this->tpl(
	...
	array(
		...
		"include_page"=>"team",
		"termId"=>$team_blog->term_id,
		"termLink"=>$team_blog_link,
	)
);?> 